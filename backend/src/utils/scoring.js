...
const CUSTOM_PATTERNS = [
    ...
    ['P2', 'P12', 'T2', 'P22', 'P7', 'P17', 'T3', 'P4'],  // Team 2
    ['P3', 'P13', 'P23', 'T3', 'P8', 'P18', 'P5', 'T4'],  // Team 3
    ['T4', 'P4', 'P14', 'P24', 'P9', 'T1', 'P19', 'P6'],  // Team 4
    ['P5', 'P15', 'T1', 'P1', 'P10', 'P20', 'P7', 'T3'],  // Team 5
    ['P6', 'T2', 'P16', 'P2', 'P11', 'P21', 'T4', 'P8'],  // Team 6
    ['P7', 'P17', 'P3', 'T3', 'P12', 'T1', 'P22', 'P9'],  // Team 7
    ['T2', 'P8', 'P18', 'P4', 'P13', 'T4', 'P23', 'P10'], // Team 8
    ['P9', 'P19', 'T4', 'P5', 'P14', 'P24', 'P11', 'T2'], // Team 9
    ['P10', 'P20', 'P6', 'T1', 'P15', 'T3', 'P1', 'P12'], // Team 10
    ['P11', 'P21', 'T3', 'P7', 'P16', 'T2', 'P2', 'P13'], // Team 11
    ['P12', 'T4', 'P22', 'P8', 'P17', 'T1', 'P3', 'P14'], // Team 12
];
